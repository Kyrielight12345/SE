        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="menu">
                        <a href="<?php echo base_url('home/index_admin'); ?>"><i class="feather-grid"></i> <span> Dashboard</span></span></a>
                    </li>
                    <li class="menu">
                        <a href="<?php echo base_url('siswa'); ?>"><i class="fas fa-graduation-cap"></i> <span> Management Siswa</span></span></a>
                    </li>
                    <li class="menu">
                        <a href="#"><i class="fas fa-chalkboard-teacher"></i> <span>Data Guru</span></span></a>
                    </li>
                    <li class="menu">
                        <a href="#"><i class="fas fa-building"></i> <span> Kurikulum </span></span></a>
                    </li>
                    <li class="menu">
